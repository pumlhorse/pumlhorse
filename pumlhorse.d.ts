...
declare module 'pumlhorse/IApp' {
	import { ISessionOutput } from 'pumlhorse/profile/ISessionOutput';
	import { IProfile } from 'pumlhorse/profile/IProfile';
	import { IScript } from 'pumlhorse/script/IScript';
