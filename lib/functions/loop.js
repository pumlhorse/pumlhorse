...
var mod = pumlhorse.module("loop")
    .function("for", ["each", "in", pumlhorse.defer("steps"), forFunction])
    .function("repeat", ["times", pumlhorse.defer("steps"), repeatFunction])
    .function("scenarios", ["cases", pumlhorse.defer("steps"), "base", scenariosFunction])
